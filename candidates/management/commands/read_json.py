...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--output', type=str, default='candidates.csv', help='Path to the output CSV file')
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS('Successfully imported JSON data and created CSV file'))
